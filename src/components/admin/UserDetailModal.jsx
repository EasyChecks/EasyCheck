            ...
            <div className="space-y-5 lg:col-span-2">
              ...
              {(() => {
                ...
                return (
                  <div className="p-5 bg-white border-2 border-gray-100 shadow-sm rounded-2xl">
                    <h4 className="flex items-center gap-2 mb-4 font-bold text-gray-800">
                      <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-purple-600" fill="none" viewBox="0 0 24 24" stroke="#f26623">
              ...
              {(() => {
                ...
                return (
                  <div className="p-5 bg-white border-2 border-gray-100 shadow-sm rounded-2xl">
                    <h4 className="flex items-center gap-2 mb-4 font-bold text-gray-800">
                      <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="#f26623">
