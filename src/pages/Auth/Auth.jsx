...
import { useAuth } from './components/AuthContexts/context'
...
function Auth() {
  ...
  return (
    ...
    <div className="min-h-screen relative bg-white">
      ...
      {/* sticky card */}
      <section
        className="font-prompt fixed inset-x-0 bottom-0 left-0 right-0 xl:left-[400px] xl:right-[400px] 2xl:left-[500px] 2xl:right-[500px] bg-white rounded-t-[28px] shadow-lg md:px-[60px] lg:px-[80px] xl:px-[40px] px-6 pb-8 pt-6 z-40 overflow-hidden"
