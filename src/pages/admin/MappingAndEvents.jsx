      ...
      <Popup autoClose={false} closeOnClick={false}>
        <div className="p-2">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="font-bold text-secondary">{name === 'ตำแหน่งใหม่' ? 'ตำแหน่งที่เลือก' : 'ผลการค้นหา'}</h3>
          </div>
          <p className="text-xs text-secondary mb-2">{name}</p>
          ...
          <button
            onClick={onClick}
            className="w-full bg-primary hover:bg-primary/90:bg-primary/80 text-white px-3 py-2.5 rounded-lg text-xs font-medium transition-colors"
          >
...
function MultiSelect({ selected, onChange, options, placeholder, label }) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <div 
        className="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus-within:border-primary:border-primary cursor-pointer min-h-[42px] flex flex-wrap gap-2 items-center"
      ...
      >
        {selected.length === 0 ? (
          ...
          selectedLabels.map((label, idx) => (
            <span key={idx} className="bg-accent text-primary px-2 py-1 rounded text-xs font-medium flex items-center gap-1">
              {label}
              <button
                type="button"
                onClick={(e) => {
                ...
                className="hover:bg-accent:bg-accent-orange/30 rounded-full"
              >
        ...
        <div className="absolute z-[2100] w-full mt-1 bg-white border-2 border-gray-200 rounded-lg shadow-lg max-h-64 overflow-hidden">
          <div className="p-2 border-b border-gray-200">
            <input
              ...
              placeholder="ค้นหา..."
              className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:border-primary:border-primary focus:outline-none"
          ...
          <div className="max-h-48 overflow-y-auto">
            {filtered.length === 0 ? (
              ...
              filtered.map(opt => (
                <div
                  key={opt.value}
                  className={`px-4 py-2 cursor-pointer hover:bg-accent:bg-accent-orange/30 flex items-center gap-2 ${
    ...
    <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:border-primary:border-primary focus:outline-none transition-colors"
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:border-primary:border-primary focus:outline-none transition-colors resize-none"
          rows="3"
      ...
      <div>
        ...
        <div className="flex items-center gap-4">
          ...
          <input
            ...
            className="w-24 px-3 py-2 border-2 border-gray-200 rounded-lg focus:border-primary:border-primary focus:outline-none text-center font-medium"
          />
        </div>
          ...
          <div>
            ...
            <div className="relative w-full">
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 text-secondary hover:text-primary:text-primary z-10"
              >
              ...
              <input
                ...
                className="w-full px-4 py-2.5 pr-10 border-2 border-gray-200 rounded-lg focus:border-primary:border-primary focus:outline-none transition-colors"
                required
              />
      ...
      <div className="flex items-center gap-3 pt-4 border-t border-gray-200">
        <button
          type="button"
          onClick={onCancel}
          className="flex-1 px-4 py-2.5 bg-accent hover:bg-accent/80:bg-accent-orange/80 text-secondary rounded-lg font-medium transition-colors"
        >
          ย้อนกลับ
        </button>
        <button
          ...
          className={`flex-1 px-4 py-2.5 rounded-lg font-medium transition-colors text-white ${
            type === 'location'
              ...
              : 'bg-primary hover:bg-primary/90:bg-primary/80'
          }`}
        >
    ...
    <div className="h-full bg-[#F5F7FA] flex flex-col overflow-hidden">
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-3xl w-full my-8">
            ...
            <div className="p-6 space-y-6 max-h-[calc(90vh-80px)] overflow-y-auto">
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-5 border-2 border-gray-100">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="font-semibold text-secondary">{detailItem.name}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-secondary">{detailItem.radius} เมตร</p>
                  </div>
                  {detailItem.type === 'event' && detailItem.locationName && (
                    <div>
                      <p className="text-sm text-gray-500 mb-1">ชื่อสถานที่</p>
                      <p className="font-semibold text-secondary">{detailItem.locationName}</p>
                    </div>
                  )}
                </div>
              </div>
              ...
              {detailItem.type === 'event' && (
                <div className="bg-white transition-colors duration-300/95 rounded-xl p-5 border-2 border-gray-200">
                  <h3 className="font-bold text-lg text-secondary mb-4 flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="font-semibold text-secondary">{detailItem.startDate || detailItem.date || '-'}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-500 mb-1">วันที่สิ้นสุด</p>
                      <p className="font-semibold text-secondary">{detailItem.endDate || detailItem.date || '-'}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-500 mb-1">เวลาเริ่ม</p>
                      <p className="font-semibold text-secondary">{detailItem.startTime || '-'}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-500 mb-1">เวลาสิ้นสุด</p>
                      <p className="font-semibold text-secondary">{detailItem.endTime || '-'}</p>
                    </div>
                  </div>
                </div>
              )}
              ...
              <div className="bg-white transition-colors duration-300/95 rounded-xl p-5 border-2 border-gray-200">
                ...
                <div className="space-y-2">
                  <div>
                    ...
                    <p className="font-mono font-semibold text-secondary">{detailItem.latitude?.toFixed(6) || '-'}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500 mb-1">ลองจิจูด (Longitude)</p>
                    <p className="font-mono font-semibold text-secondary">{detailItem.longitude?.toFixed(6) || '-'}</p>
                  </div>
                </div>
              </div>
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {detailItem.assignedRoles.map(role => (
                            <span key={role} className="bg-accent text-primary px-3 py-1 rounded-full text-sm font-medium">
            ...
            <div className="p-6 max-h-[calc(90vh-80px)] overflow-y-auto">
              {!createType ? (
                ...
                <div className="space-y-4">
                  <p className="text-secondary mb-6">เลือกประเภทที่ต้องการสร้างสำหรับตำแหน่งนี้:</p>
                  ...
                  <button
                    ...
                    className="w-full bg-green-500 hover:bg-green-600:bg-green-700 text-white px-6 py-4 rounded-xl font-medium transition-all shadow-lg hover:shadow-lg"
                  >
                  ...
                  <button
                    ...
                    className="w-full bg-primary hover:bg-primary/90:bg-primary/80 text-white px-6 py-4 rounded-xl font-medium transition-all shadow-lg hover:shadow-lg"
                  >
                    <div className="text-center">
      ...
      <div className="flex-1 min-h-0 overflow-hidden p-6">
        <div className="flex gap-4 h-full w-full min-w-0">
          {/* Left Side - Map */}
          <div className="flex-1 min-w-0 bg-white rounded-2xl shadow-lg overflow-hidden relative">
              ...
              <div className="absolute top-20 left-14 z-[1001] flex flex-col gap-2">
                ...
                {searchMarkerName && (
                  <div className="bg-white rounded-lg shadow-lg px-3 py-2 border border-gray-200 max-w-[160px]">
                    ...
                    <p className="text-xs text-secondary font-medium line-clamp-2">{searchMarkerName.split(',')[0]}</p>
                  </div>
                )}
              </div>
            )}
            ...
            <div className="absolute top-4 left-14 z-[1000] w-60">
              <div className="relative">
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2.5 bg-white border-2 border-gray-200 rounded-xl shadow-lg focus:border-primary:border-primary focus:outline-none transition-colors text-sm"
                />
                <svg
                ...
                <div className="mt-2 bg-white rounded-lg shadow-lg border border-gray-200 max-h-64 overflow-y-auto">
                  {mapSearchResults.map((result, index) => (
                    <button
                      ...
                      className="w-full text-left px-4 py-3 hover:bg-accent:bg-accent-orange/30 transition-colors border-b border-gray-100 last:border-b-0"
                    >
                      <div className="font-medium text-sm text-secondary">{result.formatted_name || result.display_name}</div>
            ...
            <div className="absolute top-4 right-4 z-[1000] flex flex-col gap-2">
              <button
                ...
                className="bg-white hover:bg-accent text-secondary px-4 py-2 rounded-lg shadow-lg font-medium text-sm transition-all flex items-center gap-2 border border-gray-200"
                title="วิธีใช้งาน"
              >
              ...
              <div className="bg-white rounded-lg shadow-lg p-3 border border-gray-200 min-w-[150px]">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-2 bg-accent px-2 py-1.5 rounded-md">
                    <span className="w-2.5 h-2.5 bg-primary rounded-full flex-shrink-0"></span>
                    <div className="flex flex-col">
                      <span className="text-xs text-primary font-medium">กิจกรรม</span>
          ...
          <div className="w-[400px] flex-shrink-0 bg-white rounded-2xl shadow-lg flex flex-col overflow-hidden border border-gray-200">
            ...
            <div className="p-4 border-b border-gray-200 space-y-3">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2.5 border-2 border-gray-200 rounded-xl focus:border-primary:border-primary focus:outline-none transition-colors text-sm"
                />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400"
                ...
                <button
                  ...
                  className={`flex-1 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
                    activeTab === 'all'
                      ...
                      : 'bg-accent text-secondary hover:bg-accent/80:bg-accent-orange/80'
                  }`}
                >
              ...
              {filteredItems.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Quick Info */}
                    <div className="flex items-center gap-4 text-xs text-secondary mb-3 flex-wrap">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      <button
                        ...
                        className="px-3 py-2 bg-primary hover:bg-primary/90:bg-primary/80 text-white rounded-lg text-sm font-medium transition-colors flex items-center justify-center gap-2"
                        title="ดูรายละเอียด"
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <button
                          ...
                          className={`w-full px-3 py-2 rounded-lg text-sm font-medium transition-colors flex items-center justify-center gap-2 ${
                            isLocation
                              ...
                              : 'bg-accent hover:bg-accent:bg-accent-orange/50 text-primary'
                          }`}
                        >
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
