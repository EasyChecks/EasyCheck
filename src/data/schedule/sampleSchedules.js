...
export const sampleSchedules = [
  {
    ...
    members: 'อภิชาติ รัตนา, นันทกร ทูนแก้ว, เทวราช วงค์ษาจันทร์',
  ...
  },
  {
    ...
    startTime: '10:00',
    endTime: '22:00',
    teams: ['Marketing', 'IT'], // แผนก Marketing และ IT เท่านั้น
    createdBy: 'admin', // 🔥 ตารางที่ Admin สร้าง
    branch: 'BKK', // 🏢 สาขากรุงเทพ
    tasks: [
  ...
  },
  {
    ...
    isPermanent: true, // ตารางถาวร
    location: 'สำนักงานใหญ่ TGS กรุงเทพ',
    members: 'สุภาพร จันทร์เพ็ญ, นันทกร ทูนแก้ว, พรทิพย์ ภักดี',
